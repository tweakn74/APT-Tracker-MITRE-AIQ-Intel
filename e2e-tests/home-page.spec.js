...
test.describe('WatchLockAI Home Page - Versedetect Style Redesign', () => {
  ...
  test('header navigation is visible and functional', async ({ page }) => {
    ...
    await expect(navLinks).toHaveCount(7); // Home, APT Profiles, Analytics, Dark Web Intel, APT Overview, Metrics, Detections
  ...
  test('footer is present with correct information', async ({ page }) => {
    ...
    await expect(footer).toContainText('Enterprise-grade, open-source threat intelligence platform');
